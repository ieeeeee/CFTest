...
namespace OA.Web.App_Start
{
    ...
    public class IocConfig
    {
        ...
        private static void RegisterForMvc()
        {
            ...
            container.RegisterMvcControllers(Assembly.GetExecutingAssembly()); //using System.Reflection;
        ...
        private static void RegisterForWebApiProxyClient(Container container)
        {
            ...
            //service
            var moduleInitializers = new ModuleInitializer[] //using OA.Basis;
            {
                new OAModuleInitializer() //using OA.Services;
            };
